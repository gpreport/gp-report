...
function saveDataAction(rowNum) {
  ...
  let apiUrl = `${m_api}?action=saveAarakhada&actionTabName=fifteenVitha`;
...
async function fetchDataList() {
  ...
  let apiUrl = `${m_api}?action=fifteenVitha&finYear=${finYearObject}&actionTabName=fifteenVitha&gramCode=${userObject.gramcode}`;
  try {
