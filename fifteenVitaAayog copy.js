...
document.getElementById("submit").addEventListener("click", () => {
  ...
  let activity = activityList.value;
  let acitityNameMr = document.getElementById("activityDetails").value;
  let focusArea = document.getElementById("focusArea").value;
  let componentType = document.getElementById("componentType").value;
  let allocatedAmount = document.getElementById("allocatedAmount").value;
...
async function fetchDataList() {
  GPAPI = fetchApiUrl("/exec?action=fifteenVitha");
